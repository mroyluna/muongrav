...
% -106.29975 35.87566
%%
box = [-106.28 35.85; -106.33 35.85; -106.33 35.92; -106.265 35.92;-106.265 35.85];
...
figure(8)
errorbar(yU,UpObs-mean(UpObs),gerr(~below_cutoff_height),'bd','markerfacecolor','b','markeredgecolor','k');
hold on
errorbar(yU, gtrendU-mean(gtrendU),trenderrU,'kd')
errorbar(yU, UpObs -gtrendU-mean(UpObs)+mean(gtrendU),errU,'rd','markerfacecolor','r','markeredgecolor','k');
%plot(xU, gtrendU-mean(gtrendU),'b--')
xlabel('N-ing, m'); ylabel('mgals');set(gca,'FontSize',[14])
legend('Observations','Regional trend','De-trended residual')
%print Upper_detrend_largebox.png -dpng

...
for i=1:length(files)
    ...
    if  rd == 2300 & drd == -900 & le == 2160 
        ...
        tstr=['Upper n = ' num2str(n) ', top density = ' num2str(rd) ', delta density = ' num2str(drd) ', layer elevation = ' num2str(le)];
        
    end
    if  rd == 2300 & drd == -900 & le == 2180 
        east = dat(:,1);
        nort = dat(:,2);
        elev = dat(:,3);
        calc = dat(:,4);
 ...
 figure(1); hold on;
            ...
            legend('Observed - trend','2140 m','2160 m','2180 m','Location','northwest');
        ...
        figure(2); hold on;
            ...
            legend('Observed - trend','2140 m','2160 m','2180 m');
        ...
        figure(1);
            filename=['../N_Upper_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../N_Upper_twolayer.png'];
            eval(['print ' filename ' -dpng']);
        figure(2); hold on
            filename=['../E_Upper_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../E_Upper_twolayer.png'];
            eval(['print ' filename ' -dpng']);
        figure(3); hold on;
            filename=['../N_Lower_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../N_Lower_twolayer.png'];
            eval(['print ' filename ' -dpng']);
        figure(4); hold on;
            filename=['../E_lower_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../E_Lower_twolayer.png'];
            eval(['print ' filename ' -dpng']);

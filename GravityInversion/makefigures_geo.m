...
%set upper layer density
urho = 2200;

cd results_geo_model/
...
for i=1:length(files)
    ...
    drd2 = str2num(nstr(ind_s(4)+1:ind_s(5)-1));
    le   = str2num(nstr(ind_s(5)+1:ind_s(6)-1));
    ht   = str2num(nstr(ind_s(6)+1:inddot-1));
    ...
    if  rd == urho & ht == 2140 
        ...
        tstr=['Upper n = ' num2str(n) ', top density = ' num2str(rd) ', middle density = ' num2str(rd+drd) ',low density = ' num2str(rd+drd+drd2) ' layer elevation = ' num2str(le) ' and ' num2str(ht) ];
    ...
    if  rd == urho  & ht == 2130  
        ...
        UpCalc2  = calc(~below_cutoff_height);
        LowCalc2 = calc(below_cutoff_height);
    ...
    if  rd == urho & ht == 2150  
        ...
        UpCalc3  = calc(~below_cutoff_height);
        LowCalc3 = calc(below_cutoff_height);
 ...
 figure(1); hold on;
            ...
            scatter(Upnort, UpCalc3,'ko')
            scatter(Upnort, UpCalc,'ko','markerfacecolor','k')
            scatter(Upnort, UpCalc2,'o','markerfacecolor',[0.85 0.85 0.85],'markeredgecolor',[0.5 0.5 0.5])
            ...
            legend('Observed - trend','2150 m','2140 m','2130 m','Location','northwest');
            xlabel('Northing (m)'); ylabel('gz (mgal)');
            set(gca,'fontsize',[14])
            filename=['geoN_Upper_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['geoN_Upper_observations.png'];
            %eval(['print ' filename ' -dpng']);
        figure(2); hold on;
            errorbar(Upeast, U, errU, 'rd','markerfacecolor','r');
            scatter(Upeast, UpCalc3,'ko')
            scatter(Upeast, UpCalc,'ko','markerfacecolor','k')
            scatter(Upeast, UpCalc2,'o','markerfacecolor',[0.85 0.85 0.85],'markeredgecolor',[0.5 0.5 0.5])
            ...
            legend('Observed - trend','2150 m','2140 m','2130 m');
            ...
            set(gca,'fontsize',[14])
            filename=['geoE_Upper_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['geoE_Upper_observations.png'];
            %eval(['print ' filename ' -dpng']);
        figure(3); hold on;
            errorbar(Lonort, L, errL, 'rd','markerfacecolor','r');
            scatter(Lonort, LowCalc3,'ko')
            scatter(Lonort, LowCalc,'ko','markerfacecolor','k')
            scatter(Lonort, LowCalc2,'o','markerfacecolor',[0.85 0.85 0.85],'markeredgecolor',[0.5 0.5 0.5])
            ...
            xlabel('Northing (m)'); ylabel('gz (mgal)');
            set(gca,'fontsize',[14])
            filename=['geoN_Lower_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['geoN_lower_observations.png'];
            %eval(['print ' filename ' -dpng']);
        figure(4); hold on;
            errorbar(Loeast, L, errL, 'rd','markerfacecolor','r');
            scatter(Loeast, LowCalc3,'ko')
            scatter(Loeast, LowCalc,'ko','markerfacecolor','k')
            scatter(Loeast, LowCalc2,'o','markerfacecolor',[0.85 0.85 0.85],'markeredgecolor',[0.5 0.5 0.5])
            ...
            xlabel('Easting (m)'); ylabel('gz (mgal)');
            set(gca,'fontsize',[14])
            filename=['geoE_lower_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['geoE_lower_observations.png'];
            %eval(['print ' filename ' -dpng']);
            
            
            
        figure(1);
            filename=['../geo_N_Upper_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../geo_N_Upper_3layer_',num2str(urho),'.png'];
            eval(['print ' filename ' -dpng']);
        figure(2); hold on
            filename=['../geo_E_Upper_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../geo_E_Upper_3layer_',num2str(urho),'.png'];
            eval(['print ' filename ' -dpng']);
        figure(3); hold on;
            filename=['../geo_N_Lower_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../geo_N_Lower_3layer_',num2str(urho),'.png'];
            eval(['print ' filename ' -dpng']);
        figure(4); hold on;
            filename=['../geo_E_lower_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../geo_E_Lower_3layer_',num2str(urho),'.png'];
            eval(['print ' filename ' -dpng']);

...
for i=1:length(files)
    ...
    if  rd == 1700 & drd == 0 & le == 2200 
        ...
        figure(1);
            filename=['../N_Upper_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../Uniform_lowrho_N_Upper_observations.png'];
            filename=['../Uniform_highrho_N_Upper_observations.png'];
            eval(['print ' filename ' -dpng']);
        figure(2); hold on
            filename=['../E_Upper_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../Uniform_lowrho_E_Upper_observations.png'];
            filename=['../Uniform_highrho_E_Upper_observations.png'];
            eval(['print ' filename ' -dpng']);
        figure(3); hold on;
            filename=['../N_Lower_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../Uniform_lowrho_N_lower_observations.png'];
            filename=['../Uniform_highrho_N_lower_observations.png'];
            eval(['print ' filename ' -dpng']);
        figure(4); hold on;
            filename=['../E_lower_', num2str(n),'_',num2str(rd),'_',num2str(drd),'_',num2str(le),'.png'];
            filename=['../Uniform_lowrho_E_lower_observations.png'];
            filename=['../Uniform_highrho_E_lower_observations.png'];
            eval(['print ' filename ' -dpng']);
